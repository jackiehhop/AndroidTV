...
import com.wangpo.widgets.tv.utils.Utils;
import com.wangpo.widgets.tv.view.FrameMainLayout;
...
public class MainActivity extends Activity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        SmoothHorizontalScrollView smoothHorizontalScrollView =  findViewById(R.id.hscroll_view);
        smoothHorizontalScrollView.setFadingEdge((int)getDimension(R.dimen.w_100)); // 滚动窗口也需要适配.
        //

...
import com.wangpo.androidtv.adapter.OpenTabTitleAdapter;
import com.wangpo.widgets.tv.bridge.EffectNoDrawBridge;
import com.wangpo.widgets.tv.bridge.OpenEffectBridge;
import com.wangpo.widgets.tv.utils.OPENLOG;
import com.wangpo.widgets.tv.view.MainUpView;
import com.wangpo.widgets.tv.view.OpenTabHost;
import com.wangpo.widgets.tv.view.SmoothHorizontalScrollView;
import com.wangpo.widgets.tv.view.TextViewWithTTF;
...
public class DemoViewPagerActivity extends Activity implements OpenTabHost.OnTabSelectListener {
    ...
    private void initAllTitleBar() {
        mOpenTabHost =  findViewById(R.id.openTabHost);
...
//        Toast.makeText(DemoViewPagerActivity.this,position+"",Toast.LENGTH_SHORT).show();
        if (viewpager != null) {
            ...
            if (view != null) {
                ...
                if (res != null) {
                    if (i == postion) {
                        ...
                        view.setTextColor(res.getColor(R.color.lb_tv_white));

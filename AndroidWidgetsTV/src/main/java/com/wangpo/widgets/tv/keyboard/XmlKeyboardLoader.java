...
public class XmlKeyboardLoader {
	...
	public SoftKeyboard loadKeyboard(int resourceId) {
		...
		try {
				...
				if (mXmlEventType == XmlResourceParser.START_TAG) {
					...
					if (XMLTAG_KEYBOARD.compareTo(attr) == 0) { // keyboard
						...
						if (softKeyboard == null) {
							Log.e(this.getClass().getSimpleName(),"XMLTAG_ROW softKeyboard null");
							return null;
						}
						...
						if (null == splitter || null == labels) {
							Log.e(this.getClass().getSimpleName(),"XMLTAG_KEYS splitter or labels null");
							return null;
						}
						...
						if (null == softKeyboard) {
							Log.e(this.getClass().getSimpleName(),"XMLTAG_KEY softKeyboard null");
							return null;
						}
			...
			Log.e(this.getClass().getSimpleName(),"loadKeyboard load over");
			return softKeyboard;
		} catch (XmlPullParserException e) {
			e.printStackTrace();
			Log.e(this.getClass().getSimpleName(),"loadKeyboard XmlPullParserException " + e.getMessage());
		} catch (IOException e) {
			e.printStackTrace();
			Log.e(this.getClass().getSimpleName(),"loadKeyboard IOException " + e.getMessage());
		} finally {
			if (xrp != null)
				xrp.close();
		}

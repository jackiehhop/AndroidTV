package com.wangpo.widgets.tv.keyboard;
...
import com.wangpo.widgets.tv.keyboard.SoftKey.SaveSoftKey;
...
public class SoftKeyboardView extends View {
	...
	protected void onDraw(Canvas rootCanvas) {
		...
		if (mCacheBitmap == null) {
			Log.e(this.getClass().getSimpleName(),"onDraw mCacheBitmap:" + mCacheBitmap);
	...
	private void drawSoftKey(Canvas canvas, SoftKey softKey, boolean isDrawState) {
		if (softKey == null) {
			Log.e(this.getClass().getSimpleName(),"softKey is null...");
			return;
		}
		// 绘制按键背景.
	...
	public void setSoftKeyPress(boolean isPress) {
		if (mSoftKeyboard == null) {
			Log.e(this.getClass().getSimpleName(),"setSoftKeyPress isPress:" + isPress);
			return;
		}
	...
	public boolean moveToNextKey(int direction) {
		if (mSoftKeyboard == null) {
			Log.e(this.getClass().getSimpleName(),"moveToNextKey mSoftKeyboard is null");
			return false;
		}
		...
		if (keyRow == null) {
			Log.e(this.getClass().getSimpleName(),"moveToNextKey keyRow is null");
			return false;
		}

		List<SoftKey> softKeys = keyRow.getSoftKeys();
		if (softKeys == null) {
			Log.e(this.getClass().getSimpleName(),"moveToNextKey keyRow -> softKeys is null");
			return false;
		}
